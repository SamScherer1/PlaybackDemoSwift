...
//    }else
//    {
//        [DemoUtility showResultWithResult:[NSString stringWithFormat:@"Registration Error:%@", error]];
...
//        if (error) {
//            [DemoUtility showResultWithResult:[NSString stringWithFormat:@"Login failed: %@", error.description]];
//        }
//    }];
//}
//
